...
1.1 To set subsidy, factor of production and capacity of each production house: Goto mysite/netIITD/views.py. Search for the quantities and change the values in front to set those.
